...
planet1_trajectory = np.array([planets[0].trajectory])
planet2_trajectory = np.array([planets[1].trajectory])
planet3_trajectory = np.array([planets[2].trajectory])
planet4_trajectory = np.array([planets[3].trajectory])
